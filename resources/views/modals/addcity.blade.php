    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">{{__('city.addcity')}}</h5>
            ...
            <div class="modal-body">
                ...
                <div class="col ">
                    ...
                    <select wire:model="zoneid" class="form-control" >
...
<div class="form-row mb-4">
            ...
            <div class="modal-footer">
                ...
                <button class="btn" id="addmodalClose" data-dismiss="modal"><i class="flaticon-cancel-12"></i>{{__('city.discard')}}</button>
                <button type="button" class="btn btn-primary" wire:click="saveup">{{__('city.save')}}</button>
            </div>
        </div>
    </div>
</div>