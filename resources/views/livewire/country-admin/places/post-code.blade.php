                    ...
                    <div class="table-responsive">
                        <table id="default-ordering" class="table table-hover dataTable" style="width: 100%;"
                            ...
                            <tbody>
                                @if (count($postcode) > 0)
                                    @foreach ($postcode as $key=> $postcodes)
                                        <tr role="row">
                                            ...
                                            {{--  <td><button  wire:click.prevent="deleteId('{{ $postcodes->id }}')"class="btn btn-danger btn-sm ">Delete</button></td> --}}
                                        </tr>
                                ...
                                @else
                                <tr>
                                    <td colspan="7"><center>Post Code Not Found</center></td>
                                </tr>
                                @endif
                            </tbody>
                        </table>
