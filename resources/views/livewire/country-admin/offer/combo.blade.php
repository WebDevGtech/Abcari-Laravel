                            ...
                            <table id="zero-config" class="table table-striped" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{__('combo.image')}}</th>
                                        <th>{{__('combo.subcategory')}} </th>
                                        <th>{{__('combo.product')}}</th>
                                      
                                        <th>{{__('combo.status')}} </th>
                                        <th >{{__('combo.action')}}</th>
                                    </tr>
                                </thead>
                                @if(count($combos) >0)
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="{{ Storage::url($combo->image); }}"  width="100" height="50" /></td>
                                        <td>{{$combo->subcategory->name }}</br>
                                        {{$combo->subcategorys->name }}

                                        </td>
                                      
                                      <td>{{$combo->product->name}}</br>
                                      ...
                                      {{$combo->products->name}}
                                        ...
                                        <td>
                                           ...
                                           <div class="col-lg-3 col-md-3 col-sm-4 col-6">
                                            <label class="switch s-success  mb-4 mr-2" for="{{$combo->id}}">
...
<td></td>
            ...
            @if(count($combos) >2)
                        ...
                        {{$combos->links('livewire-pagination')}}
                        </div>
                    </div>
