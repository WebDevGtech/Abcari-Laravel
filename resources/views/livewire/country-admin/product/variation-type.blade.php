                        ...
                        <table id="default-ordering" class="table table-hover dataTable" style="width: 100%;"
                            ...
                            <thead>
                                <tr role="row">
                                    ...
                                    <th class="text-center">VARIATION TYPE</th>
                            ...
                            <tbody>
                                        ...
                                        <tr role="row">
                                            ...
                                            <td class="text-center">
                                                <label class="switch s-icons s-outline s-outline-primary mr-2 mt-3"
                                                    for="{{ $variations->id }}">
                                                    <input type="checkbox" {{ $variations->status == '1' ? 'checked' : '' }}
                                            ...
                                            <td>
                                                <svg data-target="#editmodal"
                                                    wire:click="edit('{{ $variations->id }}')"data-toggle="modal" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                @else
                                <tr>
                                    <td colspan="5"><center>Units Type Not Found</center></td>
                                </tr>
                                @endif
