...
@include('modals.bar-coupon')
                            ...
                            <table id="zero-config" class="table table-bordered table-hover table-condensed" style="width:100%">
                                <thead>
                                    <tr>
                                        <th class="text-center">{{__('coupon.s.no')}}</th>
                                      
                                       
                                        <th class="text-center">{{__('coupon.name')}}</th>
                                        <th class="text-center">{{__('coupon.couponcode')}} </th>
                                        <th class="text-center">{{__('coupon.image')}}</th>
                                      
                                        <th class="text-center">{{__('coupon.coupontype')}} </th>
                                     
                                        <th class="text-center">{{__('coupon.status')}}</th>
                                        <th class="text-center">{{__('coupon.action')}}</th>
                                    </tr>
                                </thead>
                                @if(count($coupons) >0)
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><img src="{{ Storage::url($coupon->image); }}"  width="100" height="50" /></td>
                                        <td class="text-center">{{$coupon->coupon_type}}</td>
                                      
                                        <td class="text-center">

                                        
                                            <label class="switch s-success   mr-2 mt-3" for="{{$coupon->id}}">
                  ...
                  wire:click="updateStatus($event.target.checked,'{{$coupon->id
                                        ...
                                        <td class="text-center"> <a href="" data-toggle="modal"  wire:click="editId({{$coupon->id}})"  data-target="#editcoupon" data-placement="top" title="Edit"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg></a>
            ...
            <center>{{__('coupon.norecordfound')}}</center>
