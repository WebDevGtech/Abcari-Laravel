                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="text-center  " tabindex="0" aria-controls="default-ordering"
                                                rowspan="0" colspan="1" style="width: 59px;"
                                            ...
                                            @foreach ($city as $key => $citys)
                                                <tr role="row">
                                                    ...
                                                    <td class="text-center">
                                                        <label
                                                            class="switch s-icons s-outline s-outline-primary mr-2 mt-4"
                                                            for="{{ $citys->id }}">
                                                            <input type="checkbox"
                                                                {{ $citys->status == '1' ? 'checked' : '' }}
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        wire:click.prevent="edit('{{ $citys->id }}')"
                                                        ...
                                                        {{-- <button data-target="#editmodal"
                                                            wire:click.prevent="edit('{{ $citys->id }}')"
                                                            data-toggle="modal"
                                                            class="btn btn-primary btn-sm  ">{{ __('city.edit') }}</button> --}}
                                                    </td>
                                                    @include('modals.editcity')
                                                    {{--  <td><button data-target="#deletemodal"  data-toggle="modal"  wire:click.prevent="deleteId('{{ $citys->id }}')"class="btn btn-danger btn-sm warning confirm ">{{ __('city.delete') }}</button></td> @include('modals.deletecity') --}}
                                                </tr>
