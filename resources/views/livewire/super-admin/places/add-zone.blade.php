                            ...
                            <thead>
                                <tr role="row">
                                    ...
                                    <th class=" dt-no-sorting sorting" tabindex="0" aria-controls="default-ordering"
                                        ...
                                        aria-label="Action: activate to sort column ascending">{{ __('zone.action') }}
                                    </th>

                                    {{--  <th class=" dt-no-sorting sorting " tabindex="0" aria-controls="default-ordering" rowspan="0" colspan="1" style="width: 59px;" aria-label="Action: activate to sort column ascending">{{ __('zone.terminate') }}</th> --}}
                                </tr>
                            </thead>
                            @if (count($zone) > 0)
                                <tbody>
                                        ...
                                        <tr role="row">
                                            ...
                                            <td class="text-center">
                                                <svg data-target="#editmodal"
                                                    wire:click.prevent="edit('{{ $zones->id }}')"
                                            ...
                                            {{--  <td><button  data-target="#deletemodal" data-toggle="modal" wire:click.prevent="deleteId('{{ $zones->id }}')"class="btn btn-danger btn-sm ">{{ __('zone.delete') }}</button></td> @include('modals.deletezone') --}}
                                        </tr>
