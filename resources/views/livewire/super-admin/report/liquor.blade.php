...
<div class="layout-px-spacing">       
        ...
        <div class="  modal-body m">
          ...
          <input type="date" id="created_at" class="form-control" wire:model.defer="start_date" placeholder="Start Date">
        </div>
        <div class="col-sm-6 ">
         <label>{{ __('liquor.end')}}</label>
          <input type="date" id="created_at" class="form-control" wire:model.defer="end_date" placeholder="End Date">
        </div>
        </div>
        </div>
