...
class PaymentGateway extends Component
{
    ...
    public function saveup()
    {
        $this->validate([
            ...
            'displayname' => 'required|regex:/(^([a-z A-z]+)(\d+)?$)/u',
        ],
            [
                'name.required' => trans('paymentgateway.name_required'),
                'name.regex' => trans('paymentgateway.name_regex'),
                'name.max' => trans('paymentgateway.name_max'),
                'displayname.required' => trans('paymentgateway.displayname_required'),
                'displayname.regex' => trans('paymentgateway.displayname_regex'),
            ]);
    ...
    public function render()
    {
        ...
        return view('livewire.country-admin.settings.payment-gateway', ['payment' => $payment]);
    }
}
