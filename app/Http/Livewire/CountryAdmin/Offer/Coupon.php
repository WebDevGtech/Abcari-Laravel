...
public function deleteForm()
{
  $deletecoupon= BarCoupon::where('id',$this->deleteId)->delete();
    ...
    public function render()
    {
        ...
        $search='%'.$this->search.'%';
$this->coupon=BarCoupon::where('name','LIKE',$search)->paginate(1);
        return view('livewire.country-admin.offer.coupon',['coupons'=>$this->coupon,'products'=>$this->product]);
    }
}
