...
namespace App\Http\Livewire\CountryAdmin\SiteSetting;
...
{  
 ...
 $site=AppSetting::where('id',$id)->first();
   ...
   $site->update();
    ...
    {
        $search=$this->search.'%';
        $this->site=AppSetting::where('name','LIKE',$search)->paginate(10);
        return view('livewire.country-admin.site-setting.site-setting',['sites'=>$this->site]);
    }
}
